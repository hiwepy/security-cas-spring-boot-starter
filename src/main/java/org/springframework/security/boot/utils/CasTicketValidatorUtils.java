...
public class CasTicketValidatorUtils {
	 ...
	 */
	public static final TicketValidator createTicketValidator(final SecurityCasProperties casProperties) {
    ...
    protected static TicketValidator buildSAMLTicketValidator(final SecurityCasProperties casProperties) {
    ...
    protected static TicketValidator buildCas30TicketValidator(final SecurityCasProperties casProperties) {
    ...
    protected static TicketValidator buildCas20TicketValidator(final SecurityCasProperties casProperties) {
    ...
    protected static TicketValidator buildCas10TicketValidator(final SecurityCasProperties casProperties) {
	 ...
	 *         Certificates
	 */
	protected static Properties getSSLConfig(SecurityCasProperties casProperties) {
