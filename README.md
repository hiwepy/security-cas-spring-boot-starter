...
**Spring Boot Starter for security-cas**

[![Maven Central](https://img.shields.io/maven-central/v/io.github.easy4j/security-cas-spring-boot-starter)](https://github.com/easy-4-java/security-cas-spring-boot-starter)
...
> **Current Version**：`1.0.7-SNAPSHOT`<br>
> **JDK Baseline**：`17`<br>
> **Group ID**：`io.github.easy4j`<br>
> **Artifact ID**：`security-cas-spring-boot-starter`<br>
> **License**：Apache License 2.0<br>

## 1. Positioning

**security-cas-spring-boot-starter** is a Spring Boot starter that integrates **security-cas** for applications using security-cas. It provides auto-configuration, property binding, and ready-to-use beans so that applications can consume security-cas capabilities with minimal setup.

| Dimension | Description |
|---|---|
| Type | Spring Boot Starter |
| Consumers | Spring Boot applications using security-cas |
| Core Capabilities | auto-configuration, property binding, ready-to-use beans for security-cas |
| JDK | `17` |
| Coordinates | `io.github.easy4j:security-cas-spring-boot-starter:1.0.7-SNAPSHOT` |
| Config Prefix | `security.cas` |

## 2. Core Capabilities

| Capability | Status | Description |
|---|:---:|---|
| Auto-configuration | ✅ Stable | Registers security-cas beans automatically |
| Property Binding | ✅ Stable | Binds `security.cas.*` to `SecurityCasAuthcProperties` |
...
|---|---|---|:---:|---|:---:|
| `security.cas.enabled` | boolean | `true` | No | Enable the starter | No |
...
```bash
mvn clean verify
mvn -pl security-cas-spring-boot-starter -am test
```
...
|---|---|---|
| Bean not created | Check auto-configuration report | Verify `security.cas.enabled=true` and classpath |
...
[Back to top](#readme-top) · [Issues](https://github.com/easy-4-java/security-cas-spring-boot-starter/issues) · [Repository](https://github.com/easy-4-java/security-cas-spring-boot-starter)
